...
\cvaddress{COMERI \newline PO Box 1259 \newline Sandia Park, NM, 87047-1259} % Short address/location, use \newline if more than 1 line is required
\cvmail{spdomino@comeri.org \newline spdomin@stanford.edu } % Email address
\cvsite{ \href{https://profiles.stanford.edu/stefan-domino}{SPD's Stanford Profile Page}}
...
\begin{twentyshort}
	...
	\twentyitemshort{COMERI} {CEO/President/Esteemed Technical Staff, \href{https://comeri.org}{Computational Marine Ethology Research Institute}.}

  	\twentyitemshort{Stanford} {Adjunct Professor; School of Engineering, \href{https://profiles.stanford.edu/stefan-domino}{Institute for Computational and Mathematical Engineering (ICME)}; CTR Visiting Senior Fellow.}
...
\begin{twenty}
	...
	\twentyitem{2021-now}{Adjunct Professor} {Stanford/ICME} {Teaching responsibilities for Stanford's ME469 Mechanical Engineering graduate  \textit{Computational Methods for Fluid Dynamics} course where \href{https://github.com/COMERI/Mare-Nalu}{Mare-Nalu} is used as pedagogical tool to bridge foundational numerical methods development and practical production CFD; support mentoring of graduate students and post-doctoral appointees.}
	
	\twentyitem{2026-Spring}{Visiting Senior Fellow (Stanford visiting Scholar)} {Stanford/CTR} {Center for Turbulent Research (CTR) interactions with Stanford researchers in the technical area of multiphysics turbulence research.}

	\twentyitem{2000-2025}{Technical Staff} {Sandia National Laboratories} {Extreme scale, low-Mach turbulent fluid mechanics methods development for complex systems that drive the coupling of mass, momentum, species and energy transport. As PI, my research resides within the intersection of physics model development, numerical methods research, V\&V techniques exploration, SciML/AI, and high-performance computing and coding methods for low-Mach flow; originator of the open-source \href{https://github.com/NaluCFD}{Nalu} code base. I am proud to have served the Lab's response to National crises such as Deep Water Horizon and the COVID-19 pandemic. Served as PI and lead developer for the generally unstructured, massively parallel Sierra/Fuego code base and was a team contributor to the NNSA Defense Programs Awards of Excellence for significant contributions Stockpile Stewardship Program. Promotion to Senior Member of the Technical Staff from post-doc (2001), Principal Member of the Technical Staff (2005), and Distinguished Member of the Technical Staff (2022).}
...
\begin{twentyshort}
	...
	\twentyitemshort{2025}{Domino, S. P., Scott, S., Hubbard, J.,  \textit{Structural uncertainty assessment for fire-engulfed objects in crosswind: Establishing credibility for a multiphysics wall-modeled large-eddy simulation paradigm}, Phys. Rev. Fluids, https://doi.org/10.1103/PhysRevFluids.10.054604.}
...
\begin{twentyshort} 
	...
	\twentyitemshort{2020-2025}{\textit{Agile Physics and Engineering Models}. Advanced thermal/thermal radiation coupling techniques; elucidation of non-isothermal jet impingement physics; WM-RLES, \& data science turbulence modeling.}
	
	\twentyitemshort{2019-2025}{\textit{VVUQ Methods for Turbulent Flow}. Exploring fire-engulfed objects subjected to croswind dynamics in accident scenarios; developing structural uncertainties for LES through eigenvalue decomposition and perturbation of stresses towards limiting turbulence states.}
	...
	\twentyitemshort{2020-2021}{\textit{COVID-19 Transportation and Transmission}. High-fidelity pathogen modeling approaches for breathing and coughing events that allows for the ability to distinguish between droplets that deposit and those that form persisting aerosol plumes.}
...
\begin{twentyshort}
	...
	\twentyitemshort{2017}{Sheldon R. Tieszen Sandia National Labs Engineering Sciences Award for a distinguished career in pursuit of technical excellence.}
...
\begin{twentyshort}
	...
	\twentyitemshort{2025}{Domino, S. P., \textit{Structural uncertainty assessment for fire-engulfed objects in crosswind: Establishing credibility for a multiphysics wall-modeled large-eddy simulation paradigm}, \href{https://journals.aps.org/prfluids/edannounce/fire-crosswind-uncertainty-simulation}{Physical Review Journal Club}.}
	...
	\twentyitemshort{2009}{Domino, S. P., \textit{Computational approaches to multiphysics applications: Predicting an object's 
...
\begin{twentyshort}
	...
	\twentyitemshort{2025}{Domino, S. P., \textit{Structural uncertainty assessment for low-Mach wall-resolved large-eddy simulations: Plane Channel and Periodic Hill Use Cases}, Sandia National Laboratories, Sandia Report SAND2025-11249.}
...
\begin{twentyshort}
	...
	\twentyitemshort{2020 - now}{Teaching Me469, Stanford Mechanical Engineering Department Graduate course (2023-2025); co-teaching 2020 \& 2021: \textit{Computational Methods for Fluid Dynamics}.}
	
	\twentyitemshort{2006-2024}{Multiple visiting scholar at Stanford's CTR Summer Program.}
	
	\twentyitemshort{2001-now}{Mentoring of multiple post-doctoral researchers and graduate students; numerous internal and external peer-reviews supported including journals, DOE panels, NSF, Swiss NSF, and others.}
...
\begin{twentyshort}
	...
	\twentyitemshort{2024}{Domino, S. P., \textit{Credibility assessment for WMLES that includes fire-engulfed objects in crosswind}, Proceedings of the CTRSP (Cover image).}
...
to support advancement of multiphysics understanding of complex phenomena including turbulent 
fluid mechanics, heat transfer, and chemical reactions. Specific research thrusts center on high-fidelity
computational modeling and simulation approaches for computational marine ethology, fire, wave- \& wind-energy with a developing research thrust on generative AI, sustainability, and how computational science can support advanced approaches.
